...
import com.rminhas.avro.generated.v2.User
...
object ConsumerV2 extends App {
  ...
  val v2SchemaConsumer = createConsumerWithSchema("consumer-groupv2")

  while (true)
    printRecords(v2SchemaConsumer)
